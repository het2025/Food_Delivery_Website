        ...
        <div className="p-5 bg-white rounded-2xl shadow-2xl sm:p-7">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 mt-6 text-base font-semibold text-white rounded-xl transition bg-primary hover:bg-opacity-90 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
            >
